            ...
            <div className="container contact_container">
                <div className="contact_options">
                    <article className="contact_option">
                        ...
                        <a href="mailto:nurul.cse7@gmail.com" target="_blank" rel="noopener noreferrer" >Send an email</a>
                    </article>
                    <article className="contact_option">
                        <RiMessengerLine className='contact_option-icon' />
                        <h3>Messenger</h3>
                        <h4>facebook</h4>
                        <a href="https://m.me/nurul.bd.75" target="_blank" rel="noopener noreferrer">Send a message</a>
                    </article>
                    <article className="contact_option">
                        <BsWhatsapp className='contact_option-icon' />
                        <h3>WhatsApp</h3>
                        <h4>+8801601915577</h4>
                        <a href="https://api.whatsapp.com/send?phone=+8801601915577" target="_blank" rel="noopener noreferrer">Send a message</a>
                    </article>
                </div>
